    ...
    _createClass(JivePlaceSelector, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                    ...
                    places.map(function (item, i) {
                        return _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                contentType == 'content' && _react2.default.createElement(
                                    'span',
                                    { className: 'name' },
                                    item.subject
                                ),
                ...
                (multiple || !places.length) && _react2.default.createElement(
                    'button',
                    { onClick: this.callPicker.bind(this), disabled: this.props.limit && places.length >= this.props.limit },
        ...
        value: function add(place) {
            ...
            if (contentType == 'place') {
                itemExists = this.state.places.findIndex(function (targetPlace) {
                    return targetPlace.id == place.placeID;
                }) != -1;
            }
            if (contentType == 'content') {
                itemExists = this.state.places.findIndex(function (targetPlace) {
                    return targetPlace.id == place.contentID;
                }) != -1;
            }
